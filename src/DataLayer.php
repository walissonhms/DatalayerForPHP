...
abstract class DataLayer
{
    ...
    */
     ...
     * @return DataLayer
     */
    public function where($nameColumn, $operator = '=', $valueToCompare): DataLayer
    {
        ...
        $this->statement .= " {$nameColumn} " . " {$operator} " . " '{$valueToCompare}' ";
     ...
     * @return DataLayer
     */
    public function orWhere($nameColumn, $operator = '=', $valueToCompare): DataLayer
    {
     ...
     * @return DataLayer
     */
    public function andWhere($nameColumn, $operator = '=', $valueToCompare): DataLayer
    {
        $nameColumn = ($nameColumn ? ' AND ' . $nameColumn : null);
